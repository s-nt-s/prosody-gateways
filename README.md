...
Esto es útil porque la sincronización con los gateways (en especial
el de google) puede no respetar los cambios que haces a mano, de esta
manera (como el json tiene prioridad absoluta) se mantendrán los
nombres y grupos deseados entre sincronizaciones.
